     ...
     <div className="row">
        ...
        <form>
            ...
            <div className='form-group'>
                ...
                <input onChange={(e)=>setUpdateAddress(e.target.value)} type="text" defaultValue={updateAddress} className='form-control' 
                 />
            </div><br />
            <div className='form-group'>
                <label htmlFor="email">Email : </label>
                <input onChange={(e)=>setUpdateEmail(e.target.value)} type="text" defaultValue={updateEmail} className='form-control' 
                />
            </div><br />
            <div className='form-group'>
                <label htmlFor="contactNumber">Contact Number : </label>
                <input onChange={(e)=>setUpdateContactNumber(e.target.value)} type="text" defaultValue={updateContactNumber} className='form-control' 
                 />
            </div><br />

            <button type='button' className='btn-success btn' onClick={updateEmployee} >Update</button>
            <Link className="btn btn-danger" to={'/employeeList'} type='button' style={{marginLeft: "20px"}}>Cancel</Link>
        </form>
        </div>
        </div>
        </div>
